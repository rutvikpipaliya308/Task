...
export const Hero = () => {
    return (
        <section
            className="relative w-full h-[968px] bg-cover bg-center top-0"
                ...
                <div className="flex flex-col justify-between w-[1128px] h-[300px] text-center text-white">
                    <div className="h-[220px] flex flex-col gap-[24px]">
                        <h1 className="font-semibold text-[72px] text-customWhite leading-[83px]">
                            ...
                            <br /> venenatis quam scelerisque non.
                        </h1>
                        <p className="title-medium !text-center">
                            Fusce egestas fermentum elit ac sollicitudin. Lorem ipsum dolor
